            ...
            <div class="large-7 columns">
                <div class="panel">
                    ...
                    <form action="order.php" method="POST">
                        <p>Nummer des Gerichts: <br><input name="numberFood" class="large-4 columns" type="text" size="10" maxlength="30"></p>
                        <input class="button [tiny small large]" type="submit" name="insertFood" value=" Suchen ">
                    </form>
                </div>
            </div>
